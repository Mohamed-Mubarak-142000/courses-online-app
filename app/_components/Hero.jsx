      ...
      <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-[600px] lg:items-center ">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <a
              className="block w-full rounded border border-primary px-12 py-3 text-sm font-medium text-white hover:bg-primaryHover focus:outline-none focus:ring active:bg-primary sm:w-auto"
              href="#"
            >
              Learn More
            </a>
