    ...
    <nav aria-label="Breadcrumb" className="flex">
      <ol className="flex overflow-hidden rounded-lg border border-gray-200 text-gray-700 dark:border-gray-700 dark:text-gray-200">
        ...
        <li className="relative flex items-center">
          ...
          <a
            href="#"
            className="flex h-10 items-center capitalize bg-white pe-4 ps-8 text-xs font-medium transition hover:text-gray-900 dark:bg-gray-900 dark:hover:text-white"
          >
            {path[1]}
          </a>
        </li>
